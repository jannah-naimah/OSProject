...
7. Stop the container and delete the container. What happened to your helloworld.txt? **Deleted**
...
1. Describe what is busybox and what is command switch **--name** is for? . ***(2 mark)***
 ...
 __Busybox is Linux distribution that includes a variety of Unix utilities in a single executable file. Often used in Docker containers because its haas small size usually under 1MB and able to run many basic Linux commands.
The command switch --name is used to assign a custom name to container. As an example given, --name c1 names the first container "c1" and --name c2 names as second container "c2". This allows us to refer to the container by name rather than by its container ID__.
...
__"IPAddress": "172.18.0.2" (c1), "IPAddress": "172.19.0.2" (c2)__.
